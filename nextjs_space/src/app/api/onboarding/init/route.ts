...
export async function POST(req: NextRequest) {
  try {
    ...
    const ONBOARDING_TASKS = [
      ...
      {
        title: 'Set up Outbound Email capability',
        description: 'Go to the ⚡ Capabilities tab and configure how Divi sends emails — as you, as an agent, or both. Set rules like tone, approval requirements, and who Divi can contact.',
        priority: 'high',
        stepKey: 'setup_email_capability',
        order: 4,
      },
      {
        title: 'Approve your first outbound email in the Queue',
        description: 'After Divi analyzes your inbox, it will suggest email replies in the Queue. Review one — approve, edit, or skip it. This is how you stay in control of outbound actions.',
        priority: 'high',
        stepKey: 'approve_email_queue',
        order: 5,
      },
      {
      ...
      {
        title: 'Set up Meeting Scheduling capability',
        description: 'Go to ⚡ Capabilities and configure how Divi schedules meetings — set preferences for timing, buffer time, and which types of meetings Divi can book autonomously.',
        priority: 'medium',
        stepKey: 'setup_meetings_capability',
        order: 7,
      },
      {
