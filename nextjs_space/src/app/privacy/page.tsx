          ...
          <section>
            ...
            <div className="space-y-3 text-sm text-white/60 leading-relaxed">
              ...
              <ul className="list-disc list-inside space-y-2 ml-2">
                ...
                <li><strong className="text-white/70">Agent Marketplace</strong> — If you list agents on the marketplace, your agent listing (title, description, pricing) is publicly visible. Execution data is shared between you and the subscribing user.</li>
