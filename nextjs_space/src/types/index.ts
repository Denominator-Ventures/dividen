...
export type CenterTab = 'chat' | 'kanban' | 'crm' | 'recordings' | 'drive' | 'calendar' | 'inbox' | 'connections' | 'teams' | 'goals' | 'jobs' | 'marketplace' | 'extensions' | 'federation' | 'discover' | 'earnings';
